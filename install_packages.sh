#!/bin/sh
# Poor man's copy of Luke's Auto Rice Boostrapping Script (LARBS) by Luke Smith <luke@lukesmith.xyz>
# License: GNU GPLv3

### OPTIONS AND VARIABLES ###

while getopts ":h" o; do case "${o}" in
	h) printf "No custom use arguments allowed.\\n  This is not a clone.\\n  -h: Show this message\\n" && exit ;;
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to my fork of LARBS!\\n\\nThis will automatically install my things and probably won't even work.\\n\\n-lu1sd4" 10 60
